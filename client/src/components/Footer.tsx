      ...
      <div className="max-w-6xl mx-auto px-4 md:px-10 lg:px-16 py-12 md:py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-1">
            <img src={logoImage} alt="Дамский Каприз" className="h-12 w-auto brightness-0 invert" />
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/70 hover:bg-[#F04C8B] hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Купальники", "Женское бельё", "Мужские плавки", "Детские купальники", "Пляжная одежда"].map(
                (item, index) => (
                  <li key={index}>
                    <a href="#assortment" className="text-white/70 hover:text-white transition-colors text-sm">
                      {item}
                    </a>
                  </li>
                )
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+78612990909" className="hover:text-white transition-colors">
                  +7 (861) 299-09-09
                </a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/50">
          ...
          <p className="flex items-center gap-1">
            Сделано с
            <svg className="w-4 h-4 text-[#F04C8B]" fill="currentColor" viewBox="0 0 24 24">
