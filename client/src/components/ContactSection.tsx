...
export default function ContactSection() {
  return (
    <section id="contacts" className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-10 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="space-y-6">
            <div className="bg-[#FDF6F9] rounded-2xl p-6 md:p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#FDE4EE] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#F04C8B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#3A3A3A] hover:text-[#F04C8B] transition-colors text-lg"
                    >
                      {contactInfo.phone}
                    </a>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-[#FDE4EE]">
                ...
                <div className="flex items-center gap-4">
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-[#FDE4EE] flex items-center justify-center text-[#F04C8B] hover:bg-[#F04C8B] hover:text-white transition-colors"
                  >
