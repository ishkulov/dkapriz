...
export const routes: RouteRecordRaw[] = [
  {
    ...
    meta: {
      ...
      keywords: 'купальники, нижнее бельё, магазин Дамский Каприз, примерочные кабины'
    }
  },
  {
    path: '/kupalniki/',
    ...
    meta: {
      ...
      keywords: 'бикини, слитный купальник, купальники для пышных форм, Bahama, Ysabel Mora'
    }
  },
  {
    path: '/nizhnee-bele/',
    ...
    meta: {
      ...
      keywords: 'женское бельё, Lady Lux, Lauma, индивидуальный подбор'
    }
  },
  {
